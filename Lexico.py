...
async def processar_cadeias(linha, posicao, saida, linha_num, erro_encontrado, lista_erros):
    ...
    try:
        if linha[posicao] != '"' or ascci_out:  # Cadeia não fechada corretamente
            if linha[posicao] == '"':
            ...
            # Cadeia fechada corretamente, processar como cadeia válida
...
async def token_malformado(linha, posicao, saida, linha_num, erro_encontrado, lista_erros):
